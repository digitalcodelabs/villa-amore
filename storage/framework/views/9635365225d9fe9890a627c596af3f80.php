...
<div <?php echo e($attributes->class(['fi-simple-page'])); ?>>
    ...
    <div class="fi-simple-page-content">
        <!--[if BLOCK]><![endif]--><?php if(filled($heading) || $hasLogo || filled($subheading)): ?>
...
<?php /**PATH /var/www/villa-amore/vendor/filament/filament/resources/views/components/page/simple.blade.php ENDPATH**/ ?>